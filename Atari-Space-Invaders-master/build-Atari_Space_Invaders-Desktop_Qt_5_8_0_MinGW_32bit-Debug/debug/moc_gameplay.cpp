...
#include "../../Atari_Space_Invaders/gameplay.h"
...
QT_MOC_LITERAL(1, 9, 9), // "collision"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6), // "carlos"
QT_MOC_LITERAL(4, 27, 9), // "new_score"
QT_MOC_LITERAL(5, 37, 7) // "charlie"

    },
    "Gameplay\0collision\0\0carlos\0new_score\0"
    "charlie"
};
...
void Gameplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->carlos(); break;
        case 2: _t->new_score((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->charlie(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gameplay::collision)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Gameplay::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gameplay::carlos)) {
                *result = 1;
                return;
            }
        }
